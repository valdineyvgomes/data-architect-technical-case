CREATE OR REFRESH MATERIALIZED VIEW silver.mv_yellow_taxi_tripdata (
    type_id COMMENT "Identificador do tipo de táxi. Valor fixo 1 para corridas Yellow Taxi.",
...
COMMENT "Camada silver com registros tratados de corridas de táxi amarelo de Nova York (NYC Yellow Taxi Trip Data)."
AS
WITH transformed  AS (
SELECT
    1  AS type_id,     
...
FROM bronze.raw_yellow_taxi_tripdata
